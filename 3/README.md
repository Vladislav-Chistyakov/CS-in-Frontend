...
Необходимо создать класс для хранения неотрицательных чисел в BCD-формате. Для хранения байт следует использовать Uint8Array, где в одном байте нужно хранить одну цифру (со звездочкой (*) в одном байте 2 цифры).
